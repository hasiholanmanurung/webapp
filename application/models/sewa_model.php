<?php
    class Sewa_Model extends CI_Model{
        public function getAll(){
            $api_url = ('http://localhost:8081/getsewa/');
        ...
        public function get($idSewa){
            $api_url = ("http://localhost:8081/$idSewa");
            // die($api_url);
        ...
        // public function getSewaDetailById($idSewa) {
        //     $api_url = ("http://localhost:8081/detail/$idSewa");
        //     // die($api_url);
        ...
        //     $api_url = "http://localhost:8081/save";
