<?php
    class UserRoles_Model extends CI_Model{
        ...
        public function getAll(){
            $api_url = ('http://localhost:8088/users/getRole/');
        ...
        public function getUser($userName = NULL) {
            ...
            $api_url = ("http://localhost:8088/users/get_by_username/$userName");
        ...
        public function getUserRoleByUserId($userId = NULL) {
            ...
            $api_url = ("http://localhost:8088/users/getrole_by_userid/$userId");
        ...
        public function create() {
            $api_url = "http://localhost:8088/users/create_role";
        ...
        public function delete($userRoleId) {
            $api_url = "http://localhost:8088/users/delete_role/$userRoleId";
            // die($api_url);
            $svcGet = curl_init();
        ...
        public function updateUserRole() {
            ...
            $api_url = "http://localhost:8088/users/edit_role/$id";
