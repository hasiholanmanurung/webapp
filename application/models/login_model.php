...
class Login_Model extends CI_Model{
    ...
    public function login() {
		...
		$userPass = $this->input->post('userPass', true);		//Password enkripsi dg MD5 Hash
        
        // $api_url = "http://localhost:8088/users/get_by_email/$userEmail";
        $api_url = "http://localhost:8088/users/getrole_by_email/$userEmail";
