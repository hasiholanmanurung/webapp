<?php
    class Users_Model extends CI_Model{
        ...
        public function getAll(){
            $api_url = ('http://localhost:8088/users/get/');
        ...
        public function create() {
            $api_url = "http://localhost:8088/users/create";
        ...
        public function delete($idUser) {
            $api_url = "http://localhost:8088/users/delete/$idUser";
        ...
        public function update() {
            ...
            $api_url = "http://localhost:8088/users/edit/$idUser";
